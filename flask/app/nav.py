# https://gist.githubusercontent.com/thedod/eafad9458190755ce943e7aa58355934/raw/7f2bdf029a6d946dc61b7103b3738c5cac8ff89a/nav.py
...
class CustomBootstrapRenderer(BootstrapRenderer):
    ...
    def visit_ExtendedNavbar(self, node):
        ...
        bar_list = bar.add(tags.ul(_class='nav navbar-nav', _id = "navbar-blocks"))
        for item in node.items:
            bar_list.add(self.visit(item))

        if node.right_items:
            right_bar_list = bar.add(tags.ul(_class='nav navbar-nav navbar-right', _id = "navbar-blocks"))
